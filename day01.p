...
/*------------------------------------------------------------------------
    File        : day01.p
    Purpose     : Solve day 01 of Advent of Code 2024

    Syntax      :

    Description : Solution for Day 01 of Advent of Code 2024 in Progress OpenEdge

    Author(s)   : Wim van der Ham
    Created     : Fri Nov 29 16:35:03 CET 2024
    Notes       :
  ----------------------------------------------------------------------*/
